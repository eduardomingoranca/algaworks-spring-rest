package com.algaworks.algafood.core.security.authorizationserver.config.token;
...
public class PkceAuthorizationCodeTokenGranter extends AuthorizationCodeTokenGranter {
    ...
    private static String generateHashSha256(String plainText) {
        try {
            ...
            byte[] hash = messageDigest.digest(encode(plainText));
            return encodeBase64URLSafeString(hash);
