...
public interface FormaPagamentoControllerOpenAPI {
    ...
    @Operation(summary = "Busca uma forma de pagamento por ID", responses = {
            ...
            @ApiResponse(responseCode = "400", description = "ID da forma de pagamento invalido", content = {
    ...
    ResponseEntity<FormaPagamentoModel> buscar(@Parameter(description = "ID de uma forma de pagamento", example = "1", required = true) Long id,
    ...
    FormaPagamentoModel adicionar(@RequestBody(description = "Representacao de uma nova forma de pagamento",
    ...
    FormaPagamentoModel atualizar(@Parameter(description = "ID de uma forma de pagamento", example = "1", required = true) Long id,
                                  @RequestBody(description = "Representacao de uma forma de pagamento com os novos dados",
                                          required = true) FormaPagamentoInput formaPagamentoInput);
