...
insert into restaurante (id, nome, taxa_frete, cozinha_id, data_cadastro, data_atualizacao, ativo, aberto, endereco_cidade_id, endereco_cep, endereco_logradouro, endereco_numero, endereco_bairro) values (1, 'Thai Gourmet', 10, 1, utc_timestamp, utc_timestamp, true, true, 1, '38400-999', 'Rua John Parr', '1000', 'Centro');
...
insert into produto (nome, descricao, preco, ativo, restaurante_id) values ('T-Bone', 'Corte muito saboroso, com um osso em formato de T, sendo de um lado o contrafile e do outro o file mignon', 89, 0, 4);
...
insert into usuario (id, nome, email, senha, data_cadastro) values (1, 'John Smith', 'john.ger@algafood.com', '123', utc_timestamp), (2, 'Mary Johnson', 'mary.vnd@algafood.com', '123', utc_timestamp),
...
values (1, '65a10e1a-c7fb-43ef-9aac-7adbc5d36890', 1, 1, 1, 1, '38400-000', 'Rua Floriano Peixoto', '500', 'Apto 801', 'Brasil',
